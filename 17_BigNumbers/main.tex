...
TREE(1) = 1. With one fruit type (say, only apples), you draw a single apple. The second tree needs two fruits, so it must have two apples — but any configuration of two apples embeds the single apple. Game over.
