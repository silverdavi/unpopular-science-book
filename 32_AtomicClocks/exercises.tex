...
\]
The margin function's growth rate connects to ordinal \( \varepsilon_0 \) and surpasses Graham's number for modest inputs. (See the chapter "The Busy Beaver that Ate the TREE")
}
